...
namespace FytSoa.Core
{
    ...
    public class DbContext
    {
        ...
        public SimpleClient<Recipe> CmsRecipeDb => new SimpleClient<Recipe>(Db);
        public SimpleClient<Recipe_Series> CmsRecipe_SeriesDb => new SimpleClient<Recipe_Series>(Db);
